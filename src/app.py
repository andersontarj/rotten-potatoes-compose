...
app.config['MONGODB_HOST'] = os.getenv("MONGODB_HOST", "mongodb-rp")
app.config['MONGODB_PORT'] = int(os.getenv("MONGODB_PORT", "27017"))
app.config['MONGODB_USERNAME'] = os.getenv("MONGODB_USERNAME", "mguser")
app.config['MONGODB_PASSWORD'] = os.getenv("MONGODB_PASSWORD", "mgpwd123") 
